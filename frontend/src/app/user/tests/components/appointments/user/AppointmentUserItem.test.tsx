...
describe('AppointmentUserItem', () => {
  ...
  const appointment: Appointment = { id: 1, status: 'ESPERA', userId: "1", availableAppointment: slot, appointmentDate: slot.date, comment: 'Nota de prueba' };
  ...
  it('muestra guion si no hay comentario', () => {
    ...
    render(<AppointmentUserItem appointment={apptNoComment} slot={slot} onCancel={onCancel} afterCancel={afterCancel} />);
