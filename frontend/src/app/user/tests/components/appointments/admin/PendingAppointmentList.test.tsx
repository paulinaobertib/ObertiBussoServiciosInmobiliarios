...
describe("PendingAppointmentsList", () => {
  ...
  it("muestra spinner de carga si loading=true", () => {
    render(<PendingAppointmentsList slotsByDate={{}} apptsBySlot={{}} loading={true} onSelect={vi.fn()} />);
  ...
  it("renderiza AppointmentItem solo para turnos pendientes y llama onSelect al hacer click", () => {
    ...
    render(
      <PendingAppointmentsList slotsByDate={baseSlots} apptsBySlot={baseAppts} loading={false} onSelect={onSelect} />
    );
