...
describe("ContractItem", () => {
  it("renderiza labels de tipo y estado", () => {
    render(<ContractItem contract={baseContract as any} onDelete={() => {}} onToggleStatus={() => {}} />);
...
it("formatea fechas con fmtLongDate", () => {
  render(<ContractItem contract={baseContract as any} onDelete={() => {}} onToggleStatus={() => {}} />);
  expect(screen.getByText(/13 de Enero del 2024/)).toBeInTheDocument();
  expect(screen.getByText(/13 de Enero del 2025/)).toBeInTheDocument();
});
...
it("muestra último pago con monto y fecha", () => {
  ...
  it("muestra 'Sin registros' si no hay último pago", () => {
    ...
    render(<ContractItem contract={c as any} onDelete={() => {}} onToggleStatus={() => {}} />);
