...
describe("ServicesExpensesCard", () => {
  ...
  it("renderiza una utilidad con datos y acciones", () => {
    ...
    // montos
    expect(screen.getByText(/Monto inicial:/).parentElement).toHaveTextContent("Monto inicial: ARS $ 100");

    expect(screen.getByText(/Monto actual:/).parentElement).toHaveTextContent("Monto actual: ARS $ 100");
