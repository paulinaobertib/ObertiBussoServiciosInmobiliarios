...
describe("appointments service", () => {
  ...
  it("createAvailability: POST a /users/availableAppointments/create con body y withCredentials", async () => {
    ...
    expect(api.post).toHaveBeenCalledWith("/users/availableAppointments/create", body, { withCredentials: true });
  ...
  it("createAvailability: re-lanza error y loguea mensaje", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error creating availability:", boom);
  });
  ...
  it("updateAvailability: PATCH a /users/availableAppointments/updateAvailability/{id} con null y withCredentials", async () => {
    ...
    expect(api.patch).toHaveBeenCalledWith("/users/availableAppointments/updateAvailability/123", null, {
  ...
  it("deleteAvailability: DELETE a /users/availableAppointments/delete/{id}", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/availableAppointments/delete/55", { withCredentials: true });
    expect(r).toEqual(resp({ ok: true }));
  });
  ...
  it("getAvailabilityById: GET /users/availableAppointments/getById/{id}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/availableAppointments/getById/7", { withCredentials: true });
  ...
  it("getAllAvailabilities: GET /users/availableAppointments/getAll", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/availableAppointments/getAll", { withCredentials: true });
  ...
  it("getAvailableAppointments: GET /users/availableAppointments/available", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/availableAppointments/available", { withCredentials: true });
  ...
  it("getUnavailableAppointments: GET /users/availableAppointments/unavailable", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/availableAppointments/unavailable", { withCredentials: true });
  ...
  it("createAppointment: POST a /users/appointments/create con body y withCredentials", async () => {
    ...
    expect(api.post).toHaveBeenCalledWith("/users/appointments/create", body, { withCredentials: true });
  ...
  it("deleteAppointment: DELETE /users/appointments/delete/{id}", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/appointments/delete/44", { withCredentials: true });
    expect(r).toEqual(resp({ ok: true }));
  });
  ...
  it("updateAppointmentStatus: PUT /users/appointments/status/{id} con params {status} sin address", async () => {
    ...
    expect(api.put).toHaveBeenCalledWith("/users/appointments/status/7", null, {
  ...
  it("updateAppointmentStatus: PUT /users/appointments/status/{id} con params {status, address}", async () => {
    ...
    expect(api.put).toHaveBeenCalledWith("/users/appointments/status/8", null, {
  ...
  it("getAppointmentById: GET /users/appointments/getById/{id}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/appointments/getById/3", { withCredentials: true });
  ...
  it("getAllAppointments: GET /users/appointments/getAll", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/appointments/getAll", { withCredentials: true });
  ...
  it("getAppointmentsByUser: GET /users/appointments/user/{userId}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/appointments/user/u1", { withCredentials: true });
  ...
  it("getAppointmentsByStatus: GET /users/appointments/status con params {status}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/appointments/status", {
  ...
  it("getAvailabilityById: re-lanza error y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching availability by id:", boom);
  });
  ...
  it('updateAppointmentStatus: si address = "" NO se envía en params', async () => {
    ...
    expect(api.put).toHaveBeenCalledWith("/users/appointments/status/5", null, {
      params: { status: "PENDING" },
      withCredentials: true,
    });
  });
