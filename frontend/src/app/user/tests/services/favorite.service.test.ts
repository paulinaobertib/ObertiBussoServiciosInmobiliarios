...
describe("favorite.service", () => {
  ...
  it("getFavoritesByUser: GET /users/favorites/user/{userId}; retorna response", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/favorites/user/u1", { withCredentials: true });
  ...
  it("deleteFavorite: DELETE /users/favorites/delete/{id}; retorna response", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/favorites/delete/55", { withCredentials: true });
  ...
  it("getFavoritesByProperty: GET /users/favorites/property/{propertyId}; retorna response", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/favorites/property/777", { withCredentials: true });
