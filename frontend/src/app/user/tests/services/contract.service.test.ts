...
describe("contract.service", () => {
  ...
  it("putContract: PUT /users/contracts/update/{id} con body, withCredentials y logs de debug", async () => {
    ...
    expect(api.put).toHaveBeenCalledWith("/users/contracts/update/7", { a: 1 }, cred);
    expect(r).toEqual({ ok: true });

    // Debe haber logs de debug antes y después
    const calls = debugSpy.mock.calls.map((c) => String(c[0]));
    expect(calls.some((s) => s.includes("PUT /users/contracts/update"))).toBe(true);
  ...
  it("putContract: re-lanza y loguea status/data", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("[contract.service] Error updating contract:", {
      status: 409,
      data: "conflict",
      error: boom,
    });
  ...
  it("patchContractStatus: PATCH /users/contracts/updateStatus/{id} con null y withCredentials", async () => {
    ...
    expect(api.patch).toHaveBeenCalledWith("/users/contracts/updateStatus/9", null, cred);
    expect(r).toEqual({ ok: true });
  });
  ...
  it("patchContractStatus: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error updating contract status:", boom);
  });
  ...
  it("deleteContract: DELETE /users/contracts/delete/{id}", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/contracts/delete/3", cred);
    expect(r).toEqual({ ok: true });
  });
  ...
  it("deleteContract: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error deleting contract:", boom);
  });
  ...
  it("deleteContractsByProperty: DELETE /users/contracts/deleteByProperty/{propertyId}", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/contracts/deleteByProperty/15", cred);
    expect(r).toEqual({ ok: true });
  });
  ...
  it("deleteContractsByProperty: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error deleting contracts for property 15:", boom);
  });
  ...
  it("deleteContractsByUser: DELETE /users/contracts/deleteByUser/{userId}", async () => {
    ...
    expect(api.delete).toHaveBeenCalledWith("/users/contracts/deleteByUser/u-99", cred);
    expect(r).toEqual({ ok: true });
  });
  ...
  it("deleteContractsByUser: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error deleting contracts for user u-99:", boom);
  });
  ...
  it("getContractById: GET /users/contracts/getById/{id}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getById/22", cred);
  ...
  it("getContractById: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contract with ID 22:", boom);
  });
  ...
  it("getAllContracts: GET /users/contracts/getAll", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getAll", cred);
  ...
  it("getAllContracts: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching all contracts:", boom);
  });
  ...
  it("getContractsByUserId: GET /users/contracts/getByUser/{userId}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByUser/u1", cred);
  ...
  it("getContractsByUserId: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts for user u1:", boom);
  });
  ...
  it("getContractsByPropertyId: GET /users/contracts/getByProperty/{propertyId}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByProperty/88", cred);
  ...
  it("getContractsByPropertyId: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts for property 88:", boom);
  });
  ...
  it("getContractsByType: GET /users/contracts/getByType con params {type}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByType", {
      params: { type: "RENT" },
  ...
  it("getContractsByType: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts by type:", boom);
  });
  ...
  it("getContractsByStatus: GET /users/contracts/getByStatus con params {status}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByStatus", {
  ...
  it("getContractsByStatus: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts by status:", boom);
  });
  ...
  it("getContractsByDate: GET /users/contracts/getByDate con params {date}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByDate", {
  ...
  it("getContractsByDate: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts by date:", boom);
  });
  ...
  it("getContractsByDateRange: GET /users/contracts/getByDateRange con params {from,to}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/getByDateRange", {
  ...
  it("getContractsByDateRange: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts by date range:", boom);
  });
  ...
  it("getActiveContracts: GET /users/contracts/active", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/active", cred);
  ...
  it("getActiveContracts: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching active contracts:", boom);
  });
  ...
  it("getContractsExpiringWithin: GET /users/contracts/expiringWithinDays con params {days}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/expiringWithinDays", {
      params: { days: 45 },
      withCredentials: true,
    });
  ...
  it("getContractsExpiringWithin: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching expiring contracts:", boom);
  });
  ...
  it("getContractsEndingOn: GET /users/contracts/endingOn con params {date}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/endingOn", {
  ...
  it("getContractsEndingOn: re-lanza y loguea", async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith("Error fetching ending-on contracts:", boom);
  });
  ...
  it("getContractsEndingBetween: GET /users/contracts/endingBetween con params {from,to}", async () => {
    ...
    expect(api.get).toHaveBeenCalledWith("/users/contracts/endingBetween", {
  ...
  it("getContractsEndingBetween: re-lanza y loguea", async () => {
    ...
    (api.get as any).mockRejectedValueOnce(boom);
    await expect(getContractsEndingBetween("a", "b")).rejects.toBe(boom);
    expect(errorSpy).toHaveBeenCalledWith("Error fetching contracts ending between dates:", boom);
  });
});
