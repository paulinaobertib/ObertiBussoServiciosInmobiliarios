...
export const AppointmentItem = ({ slot, appt, onClick }: Props) => {
  ...
  return (
    ...
    >
      <Stack direction="row" alignItems="center" spacing={{ xs: 1, sm: 2 }} useFlexGap flexWrap="wrap">
        {/* Hora/fecha — ancho estable */}
        <Stack spacing={0.5} alignItems="center" sx={{ width: 64, flexShrink: 0 }}>
        ...
        {/* Estado */}
        <Chip label={chip.label} variant="outlined" color="primary" size="small" sx={{ flexShrink: 0 }} />
