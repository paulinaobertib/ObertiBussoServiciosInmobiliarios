...
describe("Footer", () => {
  ...
  it("muestra el año actual en el pie de página", () => {
    ...
    expect(
      screen.getByText(`© ${year} Oberti Busso Servicios Inmobiliarios. Todos los derechos reservados.`)
    ).toBeInTheDocument();
  });
  ...
  it("abre Facebook al hacer clic en el ícono", () => {
    ...
    expect(window.open).toHaveBeenCalledWith("https://www.facebook.com/oberti.busso/", "_blank");
  });

  it("abre Instagram al hacer clic en el ícono", () => {
    setup();
    fireEvent.click(screen.getByLabelText("Instagram"));
    expect(window.open).toHaveBeenCalledWith("https://www.instagram.com/oberti.busso/", "_blank");
  });

  it("abre WhatsApp Pablo al hacer clic en el ícono", () => {
    setup();
    fireEvent.click(screen.getByLabelText("WhatsApp Pablo"));
    expect(window.open).toHaveBeenCalledWith("https://wa.me/5493513264536", "_blank");
  });

  it("abre WhatsApp Luis al hacer clic en el ícono", () => {
    setup();
    fireEvent.click(screen.getByLabelText("WhatsApp Luis"));
    expect(window.open).toHaveBeenCalledWith("https://wa.me/5493515107888", "_blank");
  });
