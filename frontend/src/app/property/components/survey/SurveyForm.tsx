  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await alert.success({
        ...
        description:
          "Agradecemos el tiempo que te tomaste para calificar nuestro servicio. Tu opinión nos ayuda a mejorar.",
  ...
  return (
    ...
    >
      <Typography
        ...
        sx={{
          width: "100%",
          mt: { xs: "8%", sm: "6%", md: "4%", lg: "2%" },
          mb: { xs: "6%", sm: "4%", md: "2%", lg: "1%" },
        }}
      >
      ...
      <Button
        ...
        variant="contained"
        disabled={loading}
        sx={{ mt: { xs: "5%", sm: "2%" }, width: "auto", alignSelf: "center", mb: { xs: "8%", sm: "2%" } }}
      >
