    ...
    <Box sx={{ px: 4, pt: 0, pb: 4 }}>
      ...
      >
        ...
        {(!isMobile || showFilters) && (
          <>
            <FormControl sx={{ ...inputBoxStyle, py: 1, border: '2px solid #ccc', borderRadius: 1,
              '&:hover': {
                borderColor: '#444',
              },
              }}>
            ...
            <FormControl sx={inputBoxStyle}>
              <Box
                sx={{ px: 0.9, py: 1.8, display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', border: '2px solid #ccc', borderRadius: 1,
                  '&:hover': {
                    borderColor: '#444',
                  },
                 }}
            ...
            <FormControl sx={inputBoxStyle}>
              <Box
                sx={{ px: 1, py: 1.8, display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', border: '2px solid #ccc', borderRadius: 1,
                  '&:hover': {
                    borderColor: '#444',
                  },
                 }}
