...
describe("CommentItem", () => {
  it("muestra authorName cuando se provee; si no, cae a userId", () => {
    ...
    const { rerender } = render(
      <CommentItem comment={c1} authorName="Juan Pérez" onEdit={() => {}} onDelete={() => {}} />
    );
    ...
    rerender(<CommentItem comment={c2} onEdit={() => {}} onDelete={() => {}} />);
  ...
  it("muestra la descripción (con preservación de saltos de línea)", () => {
    ...
    render(<CommentItem comment={comment} onEdit={() => {}} onDelete={() => {}} />);
  ...
  it("formatea fecha y hora usando toLocaleDateString/toLocaleTimeString", () => {
    ...
    const spyDate = vi.spyOn(Date.prototype as any, "toLocaleDateString").mockReturnValue("15 sept 2025");
    const spyTime = vi.spyOn(Date.prototype as any, "toLocaleTimeString").mockReturnValue("14:05");
  ...
  it("click en Editar y Eliminar llama a sus handlers", () => {
    ...
    const { container } = render(<CommentItem comment={comment} onEdit={onEdit} onDelete={onDelete} />);
