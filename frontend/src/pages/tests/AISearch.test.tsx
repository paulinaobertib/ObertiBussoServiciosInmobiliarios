...
vi.mock("../../app/property/hooks/useAISearch", () => ({
  useAISearch: () => mockUseAISearch,
}));

// Mock del SearchBar
vi.mock("../../app/shared/components/SearchBar", () => ({
  SearchBar: ({ placeholder }: { fetchByText: any; onSearch: any; placeholder: string; debounceMs: number }) => (
    <div data-testid="search-bar">SearchBar: {placeholder}</div>
  ),
}));
